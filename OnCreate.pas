...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure imgSplashIMGClick(Sender: TObject);
...
case mode of
  spr1:
    begin
          inc(kek);
         shoplistkek.id:=kek;
         shoplistkek.name:=InputBox('Введите название магазина','Название магазина: ','');
         shoplistkek.adress:=InputBox('Введите адрес','Адрес:','ул.');
         shoplistkek.tel:=InputBox('Введите номер телефона','Номер телефона: ','+375');
  ...
  main:
    begin
      ...
      prodlistkek.Name:=InputBox('Введите название товара','Название товара: ','');
...
pprocedure TForm1.imgSplashIMGClick(Sender: TObject);
begin

end;

rocedure TForm1.N11Click(Sender: TObject);
begin
 mode:=spr1;
 writeshopList(strngrd1,shophead);
 btn1.Visible:=true;
        ...
        case Acol of
          ...
          4:
            ...
            Inc(hehid);
             ...
             sectlistkek.name:=InputBox('Введите название секции','Название секции:','');
             sectlistkek.zav:=InputBox('Заведующий секцией','Зав.секцией:','');
             sectlistkek.tel:=InputBox('Телефон','Телефон: ','+375');
        ...
        case Acol of
          ...
          3:
            begin
             ...
             sectlistkek.zav:=InputBox('Заведующий секции','Зав.секции:','');
             sectlistkek.tel:=strngrd1.Cells[4,Arow];
            end;
          4:
            begin
             sectlistkek.name:=strngrd1.Cells[1,Arow];
             sectlistkek.zav:=strngrd1.Cells[3,Arow];
             sectlistkek.tel:=inputbox('Введите телефон','Телефон: ','+375');
            end;
          5:
            begin
