...
begin
  Grid.ColCount := 7;
  Grid.RowCount := 2;
  Grid.Cells[0,0] := 'Номер магазина';
  Grid.Cells[1,0] := 'Название магазина';
  Grid.Cells[2,0] := 'Адрес магазина';
  Grid.Cells[3,0] := 'Телефон магазина';
  Grid.Cells[4,0] := 'Добавить';
  Grid.Cells[5,0] := 'Удалить';
...
begin
  Grid.ColCount := 6;
  Grid.RowCount := 2;
  Grid.Cells[0,0] := 'Номер секции';
  Grid.Cells[1,0] := 'Название секции';
  Grid.Cells[2,0] := 'Название магазина';
  Grid.Cells[3,0] := 'Зав. секцией';
  Grid.Cells[4,0] := 'Внутренний телефон';
  Grid.Cells[5,0] := 'Удалить';
  temp := head^.adr;
  while temp <> nil do
  begin
...
begin
  Grid.ColCount := 8;
  Grid.RowCount := 2;
  Grid.Cells[0,0] := 'Артикул товара';
  Grid.Cells[1,0] := 'Номер магазина';
  Grid.Cells[2,0] := 'Название магазина';
  Grid.Cells[3,0] := 'Название секции';
  Grid.Cells[4,0] := 'Дата';
  Grid.Cells[5,0] := 'Количество';
  Grid.Cells[6,0] := 'Стоимость';
  Grid.Cells[7,0] := 'Удалить';
  temp := head^.adr;
  while temp <> nil do
  begin
...
begin
      repeat
        flag:=True;
        try
        Result:=StrToInt(InputBox('Введите количество товара','Количество товара: ',''));
        except
           on E:Exception do
           begin
...
begin
      repeat
        flag:=True;
        try
        Result:=StrToCurr(InputBox('Введите цену','Цена: ',''));
        except
           on E:Exception do
           begin
           ShowMessage('Неправильное значение');
...
begin
      repeat
        flag:=True;
        try
        Result:=StrToInt(InputBox('Введите номер магазина','Номер магазина:','2'));
        except
           on E:Exception do
           begin
           ShowMessage('Неправильное значение');
...
begin
       repeat
        flag:=True;
        try
        Result:=StrToInt(InputBox('Введите номер секции','Номер секции: ','1'));
        except
           on E:Exception do
           begin
           ShowMessage('Неправильное значение');
...
begin
        repeat
        flag:=True;
       Result:=InputBox('Введите артикул товара','Артикул товара: ','');
